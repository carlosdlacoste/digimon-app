        ...
        <>
            <div className="h-screen flex justify-center items-center">
                <form className="bg-emerald-400 p-10 lg:w-1/2 md:w-1/2">
                    ...
                    <input type="text" id="name" placeholder="Full Name" className="border border-gray-400 p-2 mt-1 mb-4 w-full text-black rounded-lg"/>
                    ...
                    <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex mx-auto">Crear Digi-Elegido</button>
                </form>
            </div>
        </>
    )
